        ...
        <section id="page-title" class="row">
          ...
          <div class="col-md-4">
            ...
            <ol class="breadcrumb pull-right no-margin-bottom">
              <li><a href="#">Team Building Money Box</a></li>
              <li><a href="#">Team Building Money Box Report</a></li>
            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Team Building Money Box</h4>
                </header>
