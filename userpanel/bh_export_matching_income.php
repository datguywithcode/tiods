...
header("Content-Disposition: attachment; filename=exportMatchingIncome.csv");
...
exit;*/
$select = mysql_query("select * from credit_debit where user_id='$userid' and ttype='Matching Income' order by id desc");
