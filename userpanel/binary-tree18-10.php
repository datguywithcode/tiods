...
<html lang="en">
   ...
   <body class="">
      <div class="animsition">
         ...
         <main id="playground">
            ...
            <div class="container-fluid white-bg">
			   ...
			   <div class="panel-body">
                  ...
                  <div class="col-md-8 center-block">
                           ...
                           <tr>
                              ...
                              <td width="10%">
                                 <a href="binary-tree.php?id=<?php echo $id_show?>" class="<?php echo $pop; ?>">
                                    <div class="margint10">
									<?php if($result['sex']=="Male"){ $imgs=$m; } if($result['sex']=="Female"){ $imgs=$fmale; }
										
									?>
									
									
                                       <img src="images/<?php echo $imgs; ?>" height="50" class="round-border" id="menu_link2"/><br/><br/><?php echo $obj_func->userName($id_show);?><br/><?php echo $result['username'];?> <br><?php echo $obj_func->totalPoints($id_show,'left')."/".$obj_func->totalPoints($id_show,'right'); ?>
                           ...
                           <tr>
                              <td colspan="2">
                                 <a  <?php if(empty($user1['user_id']) && $id_show!='') 
                                    { ?> href="register.php?pl_id=<?php echo $id_show;?>&&pos=<?php echo 'left';?>&&sponsor_id=<?php echo $id_show;?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user1['user_id']; ?>&&binary=<?php echo 'left';?>" <?php } ?>  class="<?php if(!empty($user1['user_id'])){ echo $pop; } ?>"><br><br><br>
                                    ...
                                    <tr>
                                       <td colspan="2">
                                          ...
                                          <a  <?php if(empty($user2['user_id']) && $info1!='') 
                                             { ?> href="register.php?pl_id=<?php echo $info1;?>&&pos=<?php echo 'left';?>&&sponsor_id=<?php echo $id_show;?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user2['user_id']; ?>&&binary=<?php echo 'left';?>" <?php } ?>  class="<?php if(!empty($user2['user_id'])){ echo $pop; } ?>">
                    ...
                    <td align="left"><?php echo $obj_func->totalPoints($user2['country']);?></td>
                     ...
                     <a  <?php if(empty($user3['user_id']) && $info2!='') 
                        { ?> href="register.php?pl_id=<?php echo $info2;?>&&pos=<?php echo 'left';?>&&sponsor_id=<?php echo $id_show;?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user3['user_id']; ?>&&binary=<?php echo 'left';?>" <?php } ?>  class="<?php if(!empty($user3['user_id'])){ echo $pop; } ?>"> <div class="margint10"> 
                  ...
                  <a  <?php if(empty($user4['user_id']) && $info2!='') 
                     { ?> href="register.php?pl_id=<?php echo $info2;?>&&pos=<?php echo 'right';?>&&sponsor_id=<?php echo $id_show;?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user4['user_id']; ?>&&binary=<?php echo 'right';?>" <?php } ?>  class="<?php if(!empty($user4['user_id'])){ echo $pop; }  ?>"> <div class="margint10">  
               ...
               <a  <?php if(empty($user5['user_id']) && $info1!='') 
                  { ?> href="register.php?pl_id=<?php echo $info1;?>&&pos=<?php echo 'right';?>&&sponsor_id=<?php echo $id_show;?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user5['user_id']; ?>&&binary=<?php echo 'right';?>" <?php } ?>  class="<?php if(!empty($user5['user_id'])){ echo $pop; }  ?>"> <div class="margint10">  
            ...
            <a  <?php if(empty($user6['user_id']) && $info5!='') 
               { ?> href="register.php?pl_id=<?php echo $info5;?>&&pos=<?php echo 'left';?>&&sponsor_id=<?php echo $id_show;?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user6['user_id']; ?>&&binary=<?php echo 'left';?>" <?php } ?>  class="<?php if(!empty($user6['user_id'])){ echo $pop; } ?>"> <div class="margint10"><br>  
      ...
      <a  <?php if(empty($user7['user_id']) && $info5!='') 
         { ?> href="register.php?pl_id=<?php echo $info5;?>&&pos=<?php echo 'right';?>&&sponsor_id=<?php echo $id_show;?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user7['user_id']; ?>&&binary=<?php echo 'right';?>" <?php } ?>  class="<?php if(!empty($user7['user_id'])){ echo $pop; }  ?>"> <div class="margint10"> <br> 
      ...
      <a  <?php if(empty($user8['user_id']) && $id_show!='') 
         { ?> href="register.php?pl_id=<?php echo $id_show;?>&&pos=<?php echo 'right';?>&&sponsor_id=<?php echo $id_show;?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user8['user_id']; ?>&&binary=<?php echo 'right';?>" <?php } ?>  class="<?php if(!empty($user8['user_id'])){ echo $pop; }  ?>"> <div class="margint10"><br><br>
      ...
      <a  <?php if(empty($user9['user_id']) && $info8!='') 
         { ?> href="register.php?pl_id=<?php echo $info8;?>&&pos=<?php echo 'left';?>&&sponsor_id=<?php echo $id_show;?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user9['user_id']; ?>&&binary=<?php echo 'left';?>" <?php } ?>  class="<?php if(!empty($user9['user_id'])){ echo $pop; }  ?>"> <div class="margint10">  
      ...
      <a  <?php if(empty($user10['user_id']) && $info9!='') 
         { ?> href="register.php?pl_id=<?php echo $info9;?>&&pos=<?php echo 'left';?>&&sponsor_id=<?php echo $id_show;?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user10['user_id']; ?>&&binary=<?php echo 'left';?>" <?php } ?>  class="<?php if(!empty($user10['user_id'])){ echo $pop; }  ?>"> <div class="margint10">  
      ...
      <a  <?php if(empty($user11['user_id']) && $info9!='') 
         { ?> href="register.php?pl_id=<?php echo $info9;?>&&pos=<?php echo 'right';?>&&sponsor_id=<?php echo $id_show;?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user11['user_id']; ?>&&binary=<?php echo 'right';?>" <?php } ?>  class="<?php if(!empty($user11['user_id'])){ echo $pop; }  ?>"> <div class="margint10">  
     ...
     <td align="left"><?php echo $obj_func->totalPoints($user11['country']);?></td>
      ...
      <a  <?php if(empty($user12['user_id']) && $info8!='') 
         { ?> href="register.php?pl_id=<?php echo $info8;?>&&pos=<?php echo 'right';?>&&sponsor_id=<?php echo $id_show;?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user12['user_id']; ?>&&binary=<?php echo 'right';?>" <?php } ?>  class="<?php if(!empty($user12['user_id'])){ echo $pop; }  ?>"> <div class="margint10">  
     ...
     <td align="left"><?php echo $obj_func->totalPoints($user12['country']);?></td>
      ...
      <a  <?php if(empty($user13['user_id']) && $info12!='') 
         { ?> href="register.php?pl_id=<?php echo $info12;?>&&pos=<?php echo 'right';?>&&sponsor_id=<?php echo $id_show;?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user13['user_id']; ?>&&binary=<?php echo 'right';?>" <?php } ?>  class="<?php if(!empty($user13['user_id'])){ echo $pop; } ?>"> <div class="margint10">  
      ...
      <a  <?php if(empty($user14['user_id']) && $info12!='') 
         { ?> href="register.php?pl_id=<?php echo $info12;?>&&pos=<?php echo 'right';?>&&sponsor_id=<?php echo $id_show;?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user14['user_id']; ?>&&binary=<?php echo 'right';?>" <?php } ?>  class="<?php if(!empty($user14['user_id'])){ echo $pop; }  ?>"> <div class="margint10">  
