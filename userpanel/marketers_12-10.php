	...
	<main id="playground">
        ...
        <div class="container-fluid">
          <div class="row">
			...
			Photocopy this page to record all notes about your <b>Marketers</b>, as if your marketers set date for upgrading to become Networker. Or any other notes you want to add like their ambition or determination.
			</p>
			  </div>
