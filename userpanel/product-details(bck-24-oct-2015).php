              ...
              <section class="panel panel-primary">
                ...
                <div class="panel-body">
					...
					<div class="col-md-4">
                        ...
                        <img id="multizoom1" alt="zoomable" title="" src="../product_logos/<?php echo $getProddes['image'] ?>" style="max-height:250px;" />
                        </div>
                        <div id="description"><?php echo $getProddes['product_name']; ?></div>
                        ...
                        <img src="../product_logos/thumb/<?php echo $prodThumb['p_image'] ?>" alt="Apple iPad Air" title="" style="max-height:50px;" /></a>
