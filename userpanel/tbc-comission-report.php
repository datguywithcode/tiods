    ...
    <?php include("sidebar.php");?>
      ...
      <main id="playground">
        ...
        <section id="page-title" class="row">
          ...
          <div class="col-md-8">
            <h1>Team Building Commission</h1>
          ...
          <div class="col-md-4">
            ...
            <ol class="breadcrumb pull-right no-margin-bottom">
              <li><a href="#">Team Building Commission</a></li>
              <li><a href="#">Team Building Commission Report</a></li>
            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Team Building Commission</h4>
                </header>
                <div class="panel-body">
                  ...
                  <table class="table datatable">
                    ...
                    <tbody>
                     ...
                     <?php
                      $i=1;
                      $data=mysql_query("select * from credit_debit where user_id='$userid' and ttype='Matching Income' order by id desc");
