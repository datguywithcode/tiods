...
header("Content-Disposition: attachment; filename=exportSponserIncome.csv");
...
exit;*/
$select = mysql_query("select * from credit_debit where user_id='$userid' and ttype='Sponsor Income' order by id desc");
