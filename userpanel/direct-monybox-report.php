            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">BEST CLIENT
MONEYBOX</h4>
                </header>
				<center><b>Till Date BEST CLIENT
MONEYBOX = <?PHP echo Currency.$obj_func->totalMoneybox(); ?></b></center>
...
<!--<center><b>Competition ends on 	<?PHP //echo $obj_func->nextMonth('2015-11-01'); ?></b></center>-->
                <div class="panel-body">
				  ...
				  <thead>
					    <tr>
						<th> Rank</th>
						<th>Direct Commission This Month (<?php echo CURRENCY; ?>)</th>
						<th>User Name</th>
						<th>User Id</th>
                    ...
                    <tbody>
					<?php 
					$sqlpur="SELECT sum(direct_income.commission) AS commission,direct_income.income_id,user_registration.ts FROM direct_income inner join user_registration on user_registration.user_id=direct_income.income_id WHERE direct_income.status='1' and direct_income.paid_status='0' GROUP BY direct_income.income_id ORDER BY commission DESC,user_registration.ts ASC LIMIT 10";
