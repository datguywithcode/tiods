          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
				...
				<center><b>Till Date Team Building Commission = <?PHP echo Currency.$obj_func->sumTeambuildingComm($userId); ?></b></center>
                <div class="panel-body">
				  ...
				  <thead>
                    ...
                    <tbody>
					<?php 
						$sqlpur="select *,cast(ts as date) as date, cast(ts as time) as time from level_income where income_id='".$userId."'";
					...
					<tr>
					 ...
					 <td><?php echo $prod['product_volume'];  ?></td>
