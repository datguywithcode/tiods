...
mysql_query("INSERT INTO `credit_debit` (`id`, `transaction_no`, `user_id`, `credit_amt`, `debit_amt`, `admin_charge`, `receiver_id`, `sender_id`, `receive_date`, `ttype`, `TranDescription`, `Cause`, `Remark`, `invoice_no`, `product_name`, `status`, `ewallet_used_by`,`current_url`,`final_bal`) VALUES (NULL, '$rand', '$user_ids', '0', '$subamounts', '0', '123456', '$user_ids', '$date', 'Withdrawal Request', 'Withdrawal Request ', '0', 'Withdrawal Request ', '$rand', 'Withdrawal Request', '0', 'Withdrawal Ewallet','$urls','$request_amounts1')");


mysql_query("INSERT INTO `credit_debit` (`id`, `transaction_no`, `user_id`, `credit_amt`, `debit_amt`, `admin_charge`, `receiver_id`, `sender_id`, `receive_date`, `ttype`, `TranDescription`, `Cause`, `Remark`, `invoice_no`, `product_name`, `status`, `ewallet_used_by`,`current_url`,`final_bal`) VALUES (NULL, '$rand', '123456', '$subamounts', '0', '0', '123456', '$user_ids', '$date', 'Withdrawal Request', 'Withdrawal Request', '0', 'Withdrawal Request ', '$rand', 'Withdrawal Request', '0', 'Withdrawal Ewallet','$urls','$requestamout1')");
