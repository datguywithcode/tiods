<?php
   include("header.php");
		...
		if(isset($_GET['id']) && $_GET['id']!='')
	{
		...
		$id_show=trim($_GET['id']);
$str=mysql_fetch_assoc(mysql_query("select * from user_registration where (user_id='".$id_show."' OR username='".$id_show."')"));
$id_show=$str['user_id'];
		
		$sqlD=mysql_query("select down_id from level_income_binary where down_id='$id_show' and income_id='$userId'");
		if(mysql_num_rows($sqlD)>0)
		{	
		$down_id=mysql_fetch_assoc($sqlD);
		$id_show=$down_id['down_id'];
		}
		else
		{
			header("location:binary-tree.php?msg= This Member isn't in your network");
		}
	...
	$str=mysql_query("select * from user_registration where (user_id='".$id_show."' OR username='".$id_show."')");
	if(mysql_num_rows($str)>0)
	{
	$x=mysql_fetch_array($str);
	$id_show=$x['user_id'];
	}
	else
	{
		header("location:binary-tree.php?msg=User Id Doesn't Exists");
	}
...
<html lang="en">
   ...
   <body class="">
         ...
         <main id="playground">
            ...
            <section id="page-title" class="row">
               <div class="col-md-8">
                  ...
                  <?php $count112=mysql_num_rows(mysql_query("select * from level_income_binary where income_id='$id_show'"));?>
            ...
            <div class="container-fluid white-bg">
			   ...
			   <div class="panel-body">
                            ...
                            <form class="form-inline" action="binary-tree.php?id=<?php echo $_POST[id]; ?>" role="form" method="get">
                              <div class="form-group">
                                ...
                                <input type="text" name="id" class="form-control" id="user_id" onblur=usercheck(this.value,<?php echo $id_show; ?>); placeholder="Search User ID" required style="margin-top:-5px;">
							  ...
							  <div style="color:red; margin-left:150px;" id="usermsg"><?php if(isset($_GET['msg']) && !empty($_GET['msg'])){ echo $_GET['msg'];} ?></div>
                  ...
                  <div class="col-md-8 center-block">
                     <div class="table-responsive">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tree-table table-responsive">
                           <tr>
                              ...
                              <td width="10%">&nbsp;</td>
                              <td width="10%">
                                 <a href="binary-tree.php?id=<?php echo $id_show?>" class="<?php echo $pop; ?>">
                                    <div class="margint10">
									<?php if($obj_func->getGender($id_show)=="Male"){ $imgs=$m; } if($obj_func->getGender($id_show)=="Female"){ $imgs=$fmale; }
										
									?>
									
									
                                       <img src="images/<?php echo $imgs; ?>" height="50" class="round-border" id="menu_link2"/><br/><br/><?php echo $obj_func->userName($id_show);?><br/><?php echo $obj_func->getuserId($id_show);//echo $result['username'];?> <br><?php echo $obj_func->totalPoints($id_show,'left')."/".$obj_func->totalPoints($id_show,'right'); ?>
                                       ...
                                       <div class="flyout" style="display:<?php echo $disp; ?>;">
                                          <table width="100%" border="0" cellspacing="1" cellpadding="1">
											 ...
											 <tr>
                                                ...
                                                <td align="left"><?php echo $result['sex'];?></td>
                                             </tr>
											 
                                             <tr>
                                                <td align="left">Country</td>
                                                <td align="left"><?php echo $obj_func->getCountry($result['country']);?></td>
                                             </tr>
                                             <tr>
                                             ...
                                             <tr>
                                                ...
                                                <td align="left"><?php $regf=mysql_num_rows(mysql_query("select * from level_income_binary where income_id='$id_show' and leg='left'")); echo $regf; ?></td>
                                             </tr>
                                             <tr>
                                                <td align="left">Total Right</td>
                                                <td align="left"><?php $regf1=mysql_num_rows(mysql_query("select * from level_income_binary where income_id='$id_show' and leg='right'")); echo $regf1; ?></td>
                                             </tr>
                                          </table>
                                       </div>
                                    </span>
                           ...
                           <?php
							  ...
							  $fetch1=mysql_fetch_array(mysql_query("select * from $table where nom_id='$id_show' and binary_pos='left' limit 1"));
                              $info1=$fetch1['user_id'];
                              $user1=mysql_fetch_array(mysql_query("select * from user_registration where user_id='$info1'"));
                              $fetch8=mysql_fetch_array(mysql_query("select * from $table where nom_id='$id_show' and binary_pos='right' limit 1"));
                              ...
                              $info1101 = mysql_num_rows(mysql_query("select * from $table where nom_id='$id_show' and binary_pos='left' limit 1"));
                              $info81  = mysql_num_rows(mysql_query("select * from $table where nom_id='$id_show' and binary_pos='right' limit 1"));
                               ...
                               if($id_show=='')
                              {
                               $img8 = "tree_new.php_files/empty.png";
                                ...
                                elseif(empty($user8['user_id']) && $id_show!='') 
                                {
                           ...
                           <tr>
                              <td colspan="2">
                                 <a  <?php if(empty($user1['user_id']) && $id_show!='') 
                                    { ?> href="register.php?pl_id=<?php echo $id_show;?>&&pos=<?php echo 'left';?>&&sponsor_id=<?php echo $result['user_id'];?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user1['user_id']; ?>&&binary=<?php echo 'left';?>" <?php } ?>  class="<?php if(!empty($user1['user_id'])){ echo $pop; } ?>"><br><br><br>
                                    <div class="margint10"><img src="<?php echo $img1?>" height="50" class="round-border" style="margin-top:-60px;"  id="menu_link2"/><br/><?php echo $obj_func->userName($user1['user_id'])?><br/><?php echo $user1['username']?><br><?php if(!empty($user1['user_id'])){echo $obj_func->totalPoints($user1['user_id'],'left')."/".$obj_func->totalPoints($user1['user_id'],'right'); } ?>  
                                    ...
                                    <span>
                                       ...
                                       <div class="flyout" style="<?php if(!empty($user1['user_id'])){ ?>display:<?php echo $disp; } else { ?>display:none;<?php } ?>">
                                          <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                             ...
                                             <tr>
                                                <td align="left">Country</td>
                                               <td align="left"><?php echo $obj_func->totalPoints($user1['country']);?></td>
                                             </tr>
                                             <tr>
                                                <td align="left">Email</td>
                                    ...
                                    <tr>
                                       <td colspan="2">
                                          ...
                                          <a  <?php if(empty($user2['user_id']) && $info1!='') 
                                             { ?> href="register.php?pl_id=<?php echo $info1;?>&&pos=<?php echo 'left';?>&&sponsor_id=<?php echo $result['user_id'];?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user2['user_id']; ?>&&binary=<?php echo 'left';?>" <?php } ?>  class="<?php if(!empty($user2['user_id'])){ echo $pop; } ?>">
                                             <div class="margint10"><br>
                                                <img src="<?php echo $img2; ?>" height="50" class="round-border" id="menu_link2"/>
												<br/><?php echo $obj_func->userName($user2['user_id'])?><br/><?php echo $user2['username']?><br><?php if(!empty($user2['user_id'])){echo $obj_func->totalPoints($user2['user_id'],'left')."/".$obj_func->totalPoints($user2['user_id'],'right'); } ?>  
												<p class="border-green" style="width:40px; margin:1em 0 0 0; padding:0"></p>
                                             </div>
                                             <?php } else { ?>
                                             <img src="<?php echo $img2; ?>" height="50" class="round-border" id="menu_link2"/>
                     ...
                     <tr>
                     <td align="left">Country</td>
                    <td align="left"><?php echo $obj_func->totalPoints($user2['country']);?></td>
                     </tr>
                     <tr>
                     <td align="left">Email</td>
                     ...
                     <a  <?php if(empty($user3['user_id']) && $info2!='') 
                        { ?> href="register.php?pl_id=<?php echo $info2;?>&&pos=<?php echo 'left';?>&&sponsor_id=<?php echo $result['user_id'];?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user3['user_id']; ?>&&binary=<?php echo 'left';?>" <?php } ?>  class="<?php if(!empty($user3['user_id'])){ echo $pop; } ?>"> <div class="margint10"> 
                     <img src="<?php echo $img3; ?>" height="50" class="round-border" id="menu_link2"/><br/><?php echo $obj_func->userName($user3['user_id'])?><br/><?php echo $user3['username']?><br><?php if(!empty($user3['user_id'])){echo $obj_func->totalPoints($user3['user_id'],'left')."/".$obj_func->totalPoints($user3['user_id'],'right'); } ?>      <p class="border-green" style="width:40px; margin:1em 0 0 0; padding:0"></p></div>
                     <?php } else { ?>
                  ...
                  <tr>
                  <td align="left">Country</td>
                  <td align="left"><?php echo $obj_func->totalPoints($user3['country']);?></td>
                  </tr>
                  <tr>
                  <td align="left">Email</td>
                  ...
                  <a  <?php if(empty($user4['user_id']) && $info2!='') 
                     { ?> href="register.php?pl_id=<?php echo $info2;?>&&pos=<?php echo 'right';?>&&sponsor_id=<?php echo $result['user_id'];?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user4['user_id']; ?>&&binary=<?php echo 'right';?>" <?php } ?>  class="<?php if(!empty($user4['user_id'])){ echo $pop; }  ?>"> <div class="margint10">  
                  <img src="<?php echo $img4; ?>" class="round-border" height="50" id="menu_link2"/><br/><?php echo $obj_func->userName($user4['user_id'])?><br/><?php echo $user4['username']?><br><?php if(!empty($user4['user_id'])){echo $obj_func->totalPoints($user4['user_id'],'left')."/".$obj_func->totalPoints($user4['user_id'],'right'); } ?>  <p  style="width:40px; margin:1em 0 0 0; padding:0"></p></div> 
                  <?php } else { ?>
               ...
               <tr>
               <td align="left">Country</td>
               <td align="left"><?php echo $obj_func->totalPoints($user4['country']);?></td>
               </tr>
               <tr>
               <td align="left">Email</td>
               ...
               <a  <?php if(empty($user5['user_id']) && $info1!='') 
                  { ?> href="register.php?pl_id=<?php echo $info1;?>&&pos=<?php echo 'right';?>&&sponsor_id=<?php echo $result['user_id'];?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user5['user_id']; ?>&&binary=<?php echo 'right';?>" <?php } ?>  class="<?php if(!empty($user5['user_id'])){ echo $pop; }  ?>"> <div class="margint10">  
               <img src="<?php echo $img5; ?>" class="round-border" height="50" id="menu_link2"/><br/><?php echo $obj_func->userName($user5['user_id'])?><br/><?php echo $user5['username']?><br><?php if(!empty($user5['user_id'])){echo $obj_func->totalPoints($user5['user_id'],'left')."/".$obj_func->totalPoints($user5['user_id'],'right'); } ?>  <p  style="width:40px; margin:1em 0 0 0; padding:0"></p></div> 
               <?php } else { ?>
            ...
            <tr>
            <td align="left">Country</td>
            <td align="left"><?php echo $obj_func->totalPoints($user5['country']);?></td>
            </tr>
            <tr>
            <td align="left">Email</td>
            ...
            <a  <?php if(empty($user6['user_id']) && $info5!='') 
               { ?> href="register.php?pl_id=<?php echo $info5;?>&&pos=<?php echo 'left';?>&&sponsor_id=<?php echo $result['user_id'];?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user6['user_id']; ?>&&binary=<?php echo 'left';?>" <?php } ?>  class="<?php if(!empty($user6['user_id'])){ echo $pop; } ?>"> <div class="margint10"><br>  
            <img src="<?php echo $img6; ?>" class="round-border" height="50" id="menu_link2"/><br/><?php echo $obj_func->userName($user6['user_id'])?><br/><?php echo $user6['username']?><br><?php if(!empty($user6['user_id'])){echo $obj_func->totalPoints($user6['user_id'],'left')."/".$obj_func->totalPoints($user6['user_id'],'right'); } ?><p  style="width:40px; margin:1em 0 0 0; padding:0"></p></div> 
            <?php } else { ?>
      ...
      <tr>
      <td align="left">Country</td>
      <td align="left"><?php echo $obj_func->totalPoints($user6['country']);?></td>
      </tr>
      <tr>
      <td align="left">Email</td>
      ...
      <a  <?php if(empty($user7['user_id']) && $info5!='') 
         { ?> href="register.php?pl_id=<?php echo $info5;?>&&pos=<?php echo 'right';?>&&sponsor_id=<?php echo $result['user_id'];?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user7['user_id']; ?>&&binary=<?php echo 'right';?>" <?php } ?>  class="<?php if(!empty($user7['user_id'])){ echo $pop; }  ?>"> <div class="margint10"> <br> 
      <img src="<?php echo $img7; ?>" class="round-border" height="50" id="menu_link2"/><br/><?php echo $obj_func->userName($user7['user_id'])?><br/><?php echo $user7['username']?><br><?php if(!empty($user7['user_id'])){echo $obj_func->totalPoints($user7['user_id'],'left')."/".$obj_func->totalPoints($user7['user_id'],'right'); } ?><p  style="width:40px; margin:1em 0 0 0; padding:0"></p></div> 
      <?php } else { ?>
      ...
      <tr>
      <td align="left">Country</td>
      <td align="left"><?php echo $obj_func->totalPoints($user7['country']);?></td>
      </tr>
      <tr>
      <td align="left">Email</td>
      ...
      <td>&nbsp;</td>
      <td colspan="2">
      <a  <?php if(empty($user8['user_id']) && $id_show!='') 
         { ?> href="register.php?pl_id=<?php echo $id_show;?>&&pos=<?php echo 'right';?>&&sponsor_id=<?php echo $result['user_id'];?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user8['user_id']; ?>&&binary=<?php echo 'right';?>" <?php } ?>  class="<?php if(!empty($user8['user_id'])){ echo $pop; }  ?>"> <div class="margint10"><br><br>
      <img src="<?php echo $img8?>" height="50" class="round-border" style="margin-top:-60px;"  id="menu_link2"/><br/><?php echo $obj_func->userName($user8['user_id'])?><br/><?php echo $user8['username']?><br><?php if(!empty($user8['user_id'])){echo $obj_func->totalPoints($user8['user_id'],'left')."/".$obj_func->totalPoints($user8['user_id'],'right'); } ?>  <p class="border-green" style="width:40px; margin:1em 0 0 0; padding:0"></p></div>
      <span>
      <img class="callout" src="images/callout.gif" />
      ...
      <tr>
      <td align="left">Country</td>
      <td align="left"><?php echo $obj_func->totalPoints($user8['country']);?></td>
      </tr>
      <tr>
      <td align="left">Email</td>
      ...
      <a  <?php if(empty($user9['user_id']) && $info8!='') 
         { ?> href="register.php?pl_id=<?php echo $info8;?>&&pos=<?php echo 'left';?>&&sponsor_id=<?php echo $result['user_id'];?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user9['user_id']; ?>&&binary=<?php echo 'left';?>" <?php } ?>  class="<?php if(!empty($user9['user_id'])){ echo $pop; }  ?>"> <div class="margint10">  
      <img src="<?php echo $img9; ?>" class="round-border" height="50" id="menu_link2"/><br/><?php echo $obj_func->userName($user9['user_id'])?><br/><?php echo $user9['username']?><br><?php if(!empty($user9['user_id'])){echo $obj_func->totalPoints($user9['user_id'],'left')."/".$obj_func->totalPoints($user9['user_id'],'right'); } ?>
      ...
      <tr>
      <td align="left">Country</td>
      <td align="left"><?php echo $obj_func->totalPoints($user9['country']);?></td>
      </tr>
      ...
      <a  <?php if(empty($user10['user_id']) && $info9!='') 
         { ?> href="register.php?pl_id=<?php echo $info9;?>&&pos=<?php echo 'left';?>&&sponsor_id=<?php echo $result['user_id'];?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user10['user_id']; ?>&&binary=<?php echo 'left';?>" <?php } ?>  class="<?php if(!empty($user10['user_id'])){ echo $pop; }  ?>"> <div class="margint10">  
      <img src="<?php echo $img10; ?>" class="round-border" height="50" id="menu_link2"/><br/><?php echo $obj_func->userName($user10['user_id'])?><br/><?php echo $user10['username']?><br><?php if(!empty($user10['user_id'])){echo $obj_func->totalPoints($user10['user_id'],'left')."/".$obj_func->totalPoints($user10['user_id'],'right'); } ?><p  style="width:40px; margin:1em 0 0 0; padding:0"></p></div> 
      <?php } else { ?>
      ...
      <tr>
      <td align="left">Country</td>
      <td align="left"><?php echo $obj_func->totalPoints($user10['country']);?></td>
      </tr>
      <tr>
      <td align="left">Email</td>
      ...
      <a  <?php if(empty($user11['user_id']) && $info9!='') 
         { ?> href="register.php?pl_id=<?php echo $info9;?>&&pos=<?php echo 'right';?>&&sponsor_id=<?php echo $result['user_id'];?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user11['user_id']; ?>&&binary=<?php echo 'right';?>" <?php } ?>  class="<?php if(!empty($user11['user_id'])){ echo $pop; }  ?>"> <div class="margint10">  
      <img src="<?php echo $img11; ?>" class="round-border" height="50" id="menu_link2"/><br><?php echo $obj_func->userName($user11['user_id'])?><br/><?php echo $user11['username']?><br><?php if(!empty($user11['user_id'])){echo $obj_func->totalPoints($user11['user_id'],'left')."/".$obj_func->totalPoints($user11['user_id'],'right'); } ?><p  style="width:40px; margin:1em 0 0 0; padding:0"></p></div> 
      <?php } else { ?>
      ...
      <tr>
      <td align="left">Country</td>
     <td align="left"><?php echo $obj_func->totalPoints($user11['country']);?></td>
      </tr>
      <tr>
      <td align="left">Email</td>
      ...
      <a  <?php if(empty($user12['user_id']) && $info8!='') 
         { ?> href="register.php?pl_id=<?php echo $info8;?>&&pos=<?php echo 'right';?>&&sponsor_id=<?php echo $result['user_id'];?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user12['user_id']; ?>&&binary=<?php echo 'right';?>" <?php } ?>  class="<?php if(!empty($user12['user_id'])){ echo $pop; }  ?>"> <div class="margint10">  
      <img src="<?php echo $img12; ?>" class="round-border" height="50" id="menu_link2"/><br><?php echo $obj_func->userName($user12['user_id'])?><br/><?php echo $user12['username']?><br><?php if(!empty($user12['user_id'])){echo $obj_func->totalPoints($user12['user_id'],'left')."/".$obj_func->totalPoints($user12['user_id'],'right'); } ?> 
      <p  style="width:40px; margin:1em 0 0 0; padding:0"></p></div> 
      <?php } else { ?>
      ...
      <tr>
      <td align="left">Country</td>
     <td align="left"><?php echo $obj_func->totalPoints($user12['country']);?></td>
      </tr>
      <tr>
      <td align="left">Email</td>
      ...
      <a  <?php if(empty($user13['user_id']) && $info12!='') 
         { ?> href="register.php?pl_id=<?php echo $info12;?>&&pos=<?php echo 'left';?>&&sponsor_id=<?php echo $result['user_id'];?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user13['user_id']; ?>&&binary=<?php echo 'left';?>" <?php } ?>  class="<?php if(!empty($user13['user_id'])){ echo $pop; } ?>"> <div class="margint10">  
      <img src="<?php echo $img13; ?>" class="round-border" height="50" id="menu_link2"/><br><?php echo $obj_func->userName($user13['user_id'])?><br/><?php echo $user13['username']?><br><?php if(!empty($user13['user_id'])){echo $obj_func->totalPoints($user13['user_id'],'left')."/".$obj_func->totalPoints($user13['user_id'],'right'); } ?>
      <p  style="width:40px; margin:1em 0 0 0; padding:0"></p></div> 
      <?php } else { ?>
      ...
      <tr>
      <td align="left">Country</td>
      <td align="left"><?php echo $obj_func->totalPoints($user13['country']);?></td>
      </tr>
      <tr>
      <td align="left">Email</td>
      ...
      <a  <?php if(empty($user14['user_id']) && $info12!='') 
         { ?> href="register.php?pl_id=<?php echo $info12;?>&&pos=<?php echo 'right';?>&&sponsor_id=<?php echo $result['user_id'];?>"  <?php } else { ?>href="binary-tree.php?id=<?php echo $user14['user_id']; ?>&&binary=<?php echo 'right';?>" <?php } ?>  class="<?php if(!empty($user14['user_id'])){ echo $pop; }  ?>"> <div class="margint10">  
      <img src="<?php echo $img14; ?>" class="round-border" height="50" id="menu_link2"/><br><?php echo $obj_func->userName($user14['user_id'])?><br/><?php echo $user14['username']?><br><?php if(!empty($user14['user_id'])){echo $obj_func->totalPoints($user14['user_id'],'left')."/".$obj_func->totalPoints($user14['user_id'],'right'); } ?><p  style="width:40px; margin:1em 0 0 0; padding:0"></p></div> 
      <?php } else { ?>
      ...
      <tr>
      <td align="left">Country</td>
      <td align="left"><?php echo $obj_func->totalPoints($user14['country']);?></td>
      </tr>
      <tr>
      <td align="left">Email</td>
