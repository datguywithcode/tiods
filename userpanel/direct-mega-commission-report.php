            ...
            <div class="col-md-12">
              ...
              <section class="panel panel-primary">
                <header class="panel-heading">
                  <h4 class="panel-title">Direct Mega Commission</h4>
                </header>
				<center><b>Till Date Mega Direct Commission = <?PHP echo Currency.$obj_func->sumDirectMegacomission($userId); ?></b></center>
                <div class="panel-body">
				  ...
				  <thead>
                    ...
                    <tbody>
					<?php 
						$sqlpur="select *,cast(ts as date) as date, cast(ts as time) as time from direct_income_mega where income_id='".$userId."'";
