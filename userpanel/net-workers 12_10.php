  ...
  <body class="">
	...
	<main id="playground">
        ...
        <section id="page-title" class="row">
		  ...
		  <div class="col-md-3">
            <h1><a href="binary-tree.php"><span class="btn btn-primary btn-lg"><b>GENOLOGY</b></span></a></h1>
          </div>
...
where level_income_binary.income_id='".$userId."' and manage_bv_history.income_id='".$userId."' and manage_bv_history.leg='left' group by level_income_binary.down_id order by manage_bv_history.id desc";
...
inner join manage_bv_history on manage_bv_history.down_id=level_income_binary.down_id
where level_income_binary.income_id='".$userId."' and manage_bv_history.income_id='".$userId."' and manage_bv_history.leg='right' group by level_income_binary.down_id order by manage_bv_history.id desc";
