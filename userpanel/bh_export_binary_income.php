...
header("Content-Disposition: attachment; filename=exportBinaryIncome.csv");
...
exit;*/
$select = mysql_query("select * from credit_debit where user_id='$userid' and ttype='Binary Income' order by id desc");
