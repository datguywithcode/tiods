 <div class="header-section">
                ...
                <div class="logo dark-logo-bg hidden-xs hidden-sm">
                    <a href="#">
                        ...
                        <!--<span class="brand-name"><h3>My Logo</h3></span>-->
                    </a>
                </div>
                ...
                <div id="navbar-collapse-1" class="navbar-collapse collapse yamm mega-menu">
                    <ul class="nav navbar-nav">
                        <!-- Classic list -->
                        <li class="dropdown"><a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle">Shortcut <b
                                    ...
                                    <div class="yamm-content">
                                        <div class="row">
                                            <ul class="col-sm-2 list-unstyled">
                                                <li>
                                                    <p class="title">Member Management</p>
                                                </li>
                                                <li><a href="#"> Member List </a></li>
                                                <li><a href="#"> Search A Member</a></li>
                                                <li><a href="#"> Password Tracker</a></li>
                                                <li><a href="#"> Official Announcement</a></li>
                                                </ul>
                                            <ul class="col-sm-2 list-unstyled">
                                                <li>
                                                    <p class="title">Income Reports</p>
                                                </li>
                                                <li>
                                                   
                                                    <li><a href="#"> Sposnor Income Report</a></li>
                                                    <li><a href="#"> Binary Income Report </a></li>
                                                    <li><a href="#"> Matching Income Report </a></li>
                                                    <li><a href="#"> Member Package Report</a></li>
                                                  
                                                  </li>
                                                </ul>
                                            <!--<ul class="col-sm-2 list-unstyled">
                                                <li>
                                                    <p class="title">E Voucher/Pins Manage</p>
                                                </li>
                                                 <li><a href="#"> Fresh E Pin Report</a></li>
                                                    <li><a href="#"> Used E Pin Report</a></li>
                                                    <li><a href="#"> Create E Pin</a></li>
                                                    <li><a href="#"> E Pin Request Manage</a></li>
                                                 </ul>-->
                                            <ul class="col-sm-3 list-unstyled">
                                                <li>
                                                    <p class="title">Settings</p>
                                                </li>
                                               <li><a href="#"> Change Login Password</a></li>
                                                <li><a href="#"> Change Transaction Password</a></li>
                                                <li><a href="#"> Change Profile Photo </a></li>
                                                <li><a href="#"> User Email Section </a></li>
                                            ...
                                            <ul class="col-sm-3 list-unstyled custom-nav-img">
                                                ...
                                                <li><a href="#"> Add/Deduct Fund Manage</a></li>
                                                 <li><a href="#"> Open Ticket Manage</a></li>
                                                  <li><a href="#"> Direct Memeber Tree</a></li>
                                                 <li><a href="#"> Downline Member Tree</a></li>
                                            </ul>
               ...
               <!-- <li class="d-none">
                ...
                <li>
                    <a href="javascript:;" class="btn btn-default dropdown-toggle info-number" data-toggle="dropdown">
                        ...
                        <?php $count1=mysql_num_rows(mysql_query("select * from user_registration where registration_date='".date('Y-m-d')."'"));?>
                        <span class="badge bg-warning"><?php echo $count1;?></span>
                    </a>
                    ...
                    <div class="dropdown-menu dropdown-title ">
                        ...
                        <div class="title-row">
                            <h5 class="title yellow">
                                You have <?php echo $count1;?> New Register Members
                            </h5>
                            <a href="member-list.php" class="btn-warning btn-view-all">View all</a>
                        </div>
                        <div class="notification-list-scroll sidebar">
                            <div class="notification-list mail-list not-list">
                                <?php
                                $count1=mysql_query("select * from user_registration where registration_date='".date('Y-m-d')."'");
                                while($data=mysql_fetch_array($count1)) 
                                {
                                ?>
                       
                                <a href="javascript:;" class="single-mail">
                                    <span class="icon bg-danger">
                                    <?php echo substr($data['first_name'],0,1);?>
                                    </span>
                                    <strong><?php echo $data['first_name']." ".$data['last_name'];?></strong>

                                    <p>
                                        <small><?php echo $data['ts'];?></small>
                                    </p>
                                    <span class="un-read tooltips" data-original-title="Mark as Read" data-toggle="tooltip" data-placement="left">
                                        <i class="fa fa-circle"></i>
                                    </span>
                ...
                <div class="right-notification">
                    <ul class="notification-menu">
                        ...
                        <li>
                         ...
                         <?php $uer=mysql_fetch_array(mysql_query("select * from admin where id=1")); ?>      <img src="images/<?php echo $uer['image'];?>" alt="">Super Admin
                                <span class=" fa fa-angle-down"></span>
                            </a>
                            <ul class="dropdown-menu dropdown-usermenu purple pull-right">
                                <li><a href="#">  Profile Manage</a></li>
                                <!--<li>
                                    <a href="javascript:;">
                                ...
                                <li><a href="check-point.php?logout=true"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                            </ul>
                        </li>
