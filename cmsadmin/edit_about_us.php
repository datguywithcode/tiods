...
$_SESSION['rand'] = mt_rand(1111111,9999999); 
  ...
  $id=$_GET['id'];
  $sql=mysql_query("select * from about_us where id='".$id."'");
...
$str="update about_us set name='".$content."',description='".mysql_real_escape_string($description)."',status='".$status."' WHERE id='$id'";
$res=mysql_query($str)or die(mysql_error());

if($res)
{
$msg="Record Updated Successfully";
header('refresh:2, url=about_us.php');
}
}
                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Manage About Us<span style="float:right;color:red;"><?php if(isset($msg)){ echo $msg; } ?></span>
                        </header>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" method="post">
                             <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="content" class="form-control" value="<?php echo $row['name'];?>" >
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
										...
										<option value="0" <?php if($row['name']=='0'){ echo "selected"; } ?>>Active</option>
										<option value="1" <?php if($row['name']=='1'){ echo "selected"; } ?>>Inactive</option>
