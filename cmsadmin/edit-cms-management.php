...
if(isset($_POST['Add']))
{
   ...
   mysql_query("update contactdetail set description='".mysql_real_escape_string($content)."', posted_date='".date('Y-m-d')."' where id='$id'");
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <?php $data=mysql_fetch_array(mysql_query("select * from contactdetail where id='".$_GET['id']."'"));?> <?php
                $text = '' ;
