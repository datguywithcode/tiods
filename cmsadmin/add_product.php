                ...
                <div class="col-lg-12">
                    <section class="panel">
                        ...
                        <input type="hidden" name="old_image" value="<?php if(isset($image)): echo $image; endif; ?>" />
                               ...
                               <div class="form-group">
                                    <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Country:</label>
                                    <div class="col-lg-10">
                                 ...
                                 <?php $sql=mysql_query("select * from country");
                                    ...
                                    {
                                    ?>
                                 <option value="<?php echo $fetcCountry['countryid']; ?>" <?php 
                                 if(isset($_GET['edit_id']) && !empty($_GET['edit_id']))
                                    {
                                        if($fetcCountry['countryid']==$country){ echo "selected";}
                                     ...
                                     ><?php echo $fetcCountry['country'] ?></option>
                                 <?php } ?>
                              </select>
                                        <!-- <input type="text" name="networker_price" class="form-control" placeholder="Enter Networker Product Price.." required value="<?php if(isset($_GET['edit_id']) && !empty($_GET['edit_id'])){ echo $networker_price; } ?>" > -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="stock" class="form-control" placeholder="Enter stock.." required value="<?php if(isset($_GET['edit_id']) && !empty($_GET['edit_id'])){ echo $stock; } ?>" >
