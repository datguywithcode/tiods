            ...
            <div class="wrapper">
                ...
                <div class="row">
                  ...
                  <th style="text-align:center;">Actions</th>
                            ...
                            <?php 
                                  $i=1;
                                  $data=mysql_query("select * from tickets where status=1");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                 ...
                                 <th><?php echo "Resonded"; ?></th>
                                 <td>&nbsp;
                  <span style="margin-left:5px;"><a href="close-tickets-response.php?id=<?php echo $banners['id'];?>" title="View Detail">Edit</a></span>
