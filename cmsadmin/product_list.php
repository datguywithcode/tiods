                    ...
                    <div class="col-sm-12">
                        <section class="panel">
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                    <?php echo $data1['cost_price'];?>
                                </td>
                                <td>
                                    <?php echo $data1['product_volume'];?>
                                </td>
                                
                                <td><?php 
                  if($data1['image']!='')
				  {?>
                    <img src="../product_logos/<?php echo $data1['image']; ?>" width="90" height="90" />
                    <?php
                  }
				  else
				  {
				  ?>
                    <img src="../product_logos/nv.jpg" width="90" height="90" />
                    <?php
				  }
				  ?>
                  </td>
				  <td>
                                     <a href="add_product.php?edit_id=<?php echo $data1['p_cat_id'];?>"><span class='label label-primary'>Edit</span></a>&nbsp;|&nbsp;
									 <a href="addMoreProduct.php?product_id=<?php echo $data1['p_cat_id'];?>"><span class='label label-primary'>Add More Images</span></a>&nbsp;|&nbsp;
									 
									 <a href="product_list.php?delete=<?php echo $data1['p_cat_id'];?>"><span class='label label-danger'>Delete</span></a>
                                </td>
                            </tr>
                            <?php $i++;} ?>
