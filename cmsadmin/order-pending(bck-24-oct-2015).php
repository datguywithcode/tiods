...
<head>
   <?php include("header.php");?>
    ...
    <![endif]-->
	<script>
	function awbcode(awbNo,userId)
	{
		if(awbNo!='' && awbNo!=false)
		{
			$.ajax({
				url:'../ajax/ajax_awb.php',
				type:'post',
				data:{awbNo:awbNo,userId:userId,funtion:'awbNo'},
				success:function(data)
				{
					if(data==2)
					{
							alert("Successfully Updated AWB");
					}
					else if(data==3)
					{
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <section class="panel">
                            ...
                            <?php 
                                  $i=1;
                                  $data=mysql_query("select * from purchase_detail where ship_status='0'");
                            ...
                            <tr style="text-align:center;">
                                ...
                                <td>
                                    <?php echo $obj_func->userName($data1['user_id']);?>
                                </td>
                                ...
                                <td>
								 ...
								 <td>
                                  <?php echo $shipAdd['std_code']." ".$shipAdd['mobile'];?>
									...
									<td>
                                  <?php echo $obj_func->getCountry($shipAdd['country']);?>
                                </td>
								
								<td>
                                  <?php echo $shipAdd['city'];?>
                                </td>
								
								<td>
                                  <?php echo $shipAdd['address2'];?>
                                </td>
								<td>
								
                                  <input type="text" placeholder="Enter Awb No.." onblur="return awbcode(this.value,'<?php echo $data1['user_id']; ?>');" value="<?php echo $data1['ship_traking']; ?>" class="form-control" name="awb">
                                </td>
