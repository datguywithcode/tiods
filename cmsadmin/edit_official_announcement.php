...
$res=mysql_query($str)or die("error");

if($res)
{
$msg="New NEWS Uploaded";
header("location:official-announcement.php");

echo "<script>window.location.href='edit_member_profile.php?id=". $id."&msg1=Official announcement Updated Successfully !'</script>";
}}
